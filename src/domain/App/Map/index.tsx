...
import { PlantDetailModal } from "@domain/App/Map/components/PlantDetailModal";
import { AddPlantFAB } from "@domain/App/Map/components/AddPlantFAB";
...
import { useMapMarkers } from "@domain/App/Map/hooks/useMapMarkers";                // 지도 마커 관리
...
import { getFlowerImageForPlant } from "@domain/App/Map/utils/markerUtils.ts";                           // 식물별 꽃 이미지 가져오기
