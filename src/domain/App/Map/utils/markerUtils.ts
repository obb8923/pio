import { flowerImages,plantTypeImages } from '@domain/App/Map/constants/images.ts';
 ...
 */
export const getFlowerImageForPlant = (typeCode:number,plantId: string) => {
  if(typeCode===1){
    ...
    return plantTypeImages[typeCode]
  }
